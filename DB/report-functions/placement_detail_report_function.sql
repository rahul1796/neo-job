-- FUNCTION: reports.fn_get_placement_detail_report_data(text, text, integer, integer, text, integer, text, text, text, text, integer, integer, integer, integer, text, text, text, text, integer)

-- DROP FUNCTION reports.fn_get_placement_detail_report_data(text, text, integer, integer, text, integer, text, text, text, text, integer, integer, integer, integer, text, text, text, text, integer);
...
CREATE OR REPLACE FUNCTION reports.fn_get_placement_detail_report_data(
	...
	i_job_title text,
	i_user_id integer)
    RETURNS TABLE(region_name text, batch_code text, batch_start_date text, batch_end_date text, center_name text, batch_customer_name text, batch_contract_id text, candidate_name text, enrollment_no text, date_of_birth text, candidate_current_status text, current_status_changed_on text, contact_no text, interview_date text, date_of_join text, customer_name text, job_location text, job_title text, job_qualification_pack text, business_vertical text, job_created_by text, job_created_by_user_role text, employment_type text, salary text, state_name text, district_name text, city_name text, pin_code text, gender text, offer_letter_uploaded_date text, offer_letter_file text, certification_status text)
    LANGUAGE 'plpgsql'
...
ALTER FUNCTION reports.fn_get_placement_detail_report_data(text, text, integer, integer, text, integer, text, text, text, text, integer, integer, integer, integer, text, text, text, text, integer)
    OWNER TO postgres;
