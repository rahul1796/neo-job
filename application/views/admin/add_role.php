	 	...
	 	<div class="col-sm-12">
        	<section class="panel">
            	<div class="panel-body">
              		<form class="form-horizontal" method="post" data-validate="parsley" action="<?php echo site_url('admin/p_add_role') ?>" >
              			<?php echo form_error('_check_login','<span class="error_inp">','</span>')?>      
                		<div class="form-group">
                  			<label class="col-lg-3 control-label">Role</label>
                  				<div class="col-lg-8">
                    				<input type="text" name="role" placeholder="role" class="bg-focus form-control"   value="">
                											...
                											<?php 
                												...
                												<?php 
                													foreach($task_id_link as $ti=>$td)
                													{
                														...
                														?>
                														<li><b><input type="checkbox" name="task_ids[]" value="<?php echo $id; ?>" class="task_ids"> <?php echo ucfirst(str_ireplace('_',' ',$task)); ?></b></li>
                														<?php 
                													}
                												?>
                													</ul>
