    ...
    <div class=" breadcrumbs-top col-md-10 col-xs-12" style="margin-bottom: 10px;">
        <div class="breadcrumb-wrapper col-xs-12">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Edit RS Vertical</li>
            </ol>
        </div>
    </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title" id="bordered-layout-basic-form">Edit Vertical Info</h4>
                    ...
                    <div class="card-body collapse in">
                        <div class="card-block">
                            <form class="form form-horizontal form-bordered" id="edit_rs_vertical" method="post">
                                <div class="form-body">
                                    <input type="hidden" class="form-control" name="rs_vertical_id" value="<?php echo $rs_vertical_data['id']; ?>" />
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <div class='input-group' id='rs_vertical_name'>
                                                <input type="text" class="form-control" name="rs_vertical_name" value="<?php echo $rs_vertical_data['name']; ?>" placeholder="RS Vertical Name" />
                                            </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <div class='input-group' id='rs_vertical_code'>
                                                <input type="text" class="form-control" name="rs_vertical_code" value="<?php echo $rs_vertical_data['code']; ?>" placeholder="RS Vertical Code" />
                                            </div>
                                            <span class="error_label"></span>
                                        </div>
                                    </div>
    ...
    $("#edit_rs_vertical").validate({
     ...
     submitHandler: function (form) 
     {
          $.ajax({
             ...
             data: $('#edit_rs_vertical').serialize(),
             dataType:'json',
             success: function (data)
             {
                 var form="#edit_rs_vertical";
                 if (data.status == true)
                 {
                     swal({
                             title: "",
