...
<div class="content-body" style="overflow-x: hidden !important;">
    <a href="<?php echo base_url("pramaan/add_sourcing_admin")?>"><button type="button" class="btn btn-success btn-min-width mr-1 mb-1"><i class="icon-android-add"></i> Add Sourcing Admin</button></a>
    <!-- File export table -->
    <div class=" breadcrumbs-top col-md-9 col-xs-12">
        <div class="breadcrumb-wrapper col-xs-12">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Sourcing Admins
                </li>
            </ol>
        </div>
    </div>
            ...
            <div class="col-xs-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Available Sourcing Admins</h4>
                    ...
                    <div class="card-body collapse in">
                        <div class="card-block card-dashboard">
                            ...
                            <table id="tblSrAdmin" class="table table-striped table-bordered display responsive nowrap" style="width:100% !important;">
                                <thead>
                                <tr>
                                    <th>SNo.</th>
...
$(document).ready(function() {
    table = $('#tblSrAdmin').DataTable({
       // "stateSave": true,
        ...
        "ajax": {
            "url": base_url + "pramaan/sourcing_admins_list/"+"<?php echo $user_id;?>"+"/"+"<?php echo $user_group_id;?>",
            "type": "POST",
            error: function()
            {
                $("#tblSrAdmin tbody").empty().append('<tr><td style="text-align: center;" colspan="9">No data found</td></tr>');
            }
        },
        "columnDefs":
            [
...
function EditSourcingAdmin(SrAdminId)
{
    if (SrAdminId) {
        document.location.href = base_url + 'pramaan/edit_sourcing_admin/'+ SrAdminId;
    }
}
    ...
    swal(
        ...
        function(isConfirm) {
            if (isConfirm) {
                $.ajax({
                    type: "POST",
                    url: base_url + "pramaan/change_sr_admin_active_status",
                    data: {
                        'id': id,
