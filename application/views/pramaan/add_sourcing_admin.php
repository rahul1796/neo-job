...
<div class="content-body" style="overflow-x: hidden;"><!-- Basic form layout section start -->
	<div class=" breadcrumbs-top col-md-10 col-xs-12" style="margin-bottom: 10px;">
		<div class="breadcrumb-wrapper col-xs-12">
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><?php echo anchor("pramaan/sourcing_admins","Sourcing Admin");?></li>
								...
								<div class="form-body">
									<div class="form-group row">
										...
										<div class="col-sm-9">
											...
											<input type="text" class="form-control" name="pname" id="pname" placeholder="Enter Sourcing Admin Name">
									...
									<div class="form-group row">
										...
										<div class="col-sm-9">
											<input type="text" class="form-control" name="phone" id="phone" maxlength="<?= PHONE_MAX?>" placeholder="Enter Sourcing Admin Phone">
											<span class="error_label"></span>
										</div>
									</div>
									<div class="form-group row">
										...
										<div class="col-sm-9">
											<input type="text" class="form-control" name="email" id="email" maxlength="<?= EMAIL_MAX?>" placeholder="Enter Sourcing Admin Email">
											<span class="error_label"></span>
										</div>
									</div>
									<div class="form-group row">
										<label for="sourcing_head" class="col-sm-3 label-control">Sourcing head<span class="validmark">*</span></label>
										<div class="col-sm-9">
											<?php echo form_dropdown('sourcing_head_id',$sourcing_head_options,'','id="sourcing_head" class="form-control"');?>
											<span class="error_label"></span>
										</div>
									</div>
									<div class="form-group row">
