...
<small>
  <ul class="breadcrumb" style="padding: 0px;">
    ...
    <li class="active"> Qualification Pack</li>
  </ul>
</small>
<hr/>
...
<div id="myModal1" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                <button type="button" class="btn btn-primary" onclick="change_state();">Yes</button>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
 ...
 $.ajax({
        url : base_url+"pramaan/get_qualification_list",
        type: "POST",
        dataType: "JSON",
         ...
         /* alert("OK!");*/
          ...
          /* alert(msg.length);*/
           ...
           {    
                ...
                cell2[i].innerHTML = msg[i]['code'];
                cell3[i].innerHTML = msg[i]['name'];
                cell4[i].innerHTML = msg[i]['sector_name'];
...
function show(id)
{
    ...
    if (r == true) {
        ...
        var ar=[id];
        var url;
         url = base_url+"pramaan/change_qualification_pack_status";
         $.ajax({
        url : url,
        data:{ar:ar},
        type: "POST",
