...
<div class="content-body" style="overflow-x: hidden !important;">
    <a class="btn btn-success btn-min-width mr-1 mb-1" href="<?php echo base_url("pramaan/add_rs_sector/$parent_id")?>" style="margin-left: 50px;"><i class="icon-android-add"></i>Add Sector</a>
    ...
    <div class=" breadcrumbs-top col-md-9 col-xs-12" style="margin-bottom: 10px;">
        <div class="breadcrumb-wrapper col-xs-12">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Sectors
                </li>
            </ol>
        </div>
    </div>
            ...
            <div class="col-xs-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Available Sectors</h4>
                    ...
                    <div class="card-body collapse in">
                        <div class="card-block card-dashboard">
                           <table id="tblSec" class="table table-striped table-bordered" style="width:100% !important;">
                                <thead>
                                <tr>
                                    <th>SNo.</th>
                                    <th>Sector Name</th>
...
$(document).ready(function() {
    table = $('#tblSec').DataTable({
        ...
        "ajax": {
            "url": base_url + "pramaan/rs_sectors_list/"+"<?php echo $parent_id;?>",
            "type": "POST",
            error: function()
            {
