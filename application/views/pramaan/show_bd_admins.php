    ...
    <div class=" breadcrumbs-top col-md-9 col-xs-12" style="margin-bottom: 10px;">
        <div class="breadcrumb-wrapper col-xs-12">
            <ol class="breadcrumb">
                ...
                ?>
                <li class="breadcrumb-item active">Recruitment Admin
                </li>
            </ol>
        </div>
    </div>
            ...
            <div class="col-xs-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Available Recruitment Admins</h4>
...
$(document).ready(function() {
    table = $('#tblBdAdmin').DataTable({
        ...
        "ajax": {
            "url": base_url + "pramaan/show_bd_admin_list/"+"<?php echo $parent_id;?>",
            "type": "POST",
            error: function()
            {
