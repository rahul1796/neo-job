...
<small>
  <ul class="breadcrumb" style="padding: 0px;">
    <li><?php echo anchor("pramaan/dashboard","Sourcing heads");?></li>
    <?php if($parent_page)
...
<script type="text/javascript">
 ...
 $.ajax({
        url : base_url+"pramaan/regional_managers_list_view/"+"<?php echo $parent_id;?>",
        type: "POST",
        dataType: "JSON",
        success: function(msg)
        {
          ...
          /* alert(msg.length);*/
           ...
           {    
                ...
                cell6[i].innerHTML = msg[i]['sourcing_head'];
