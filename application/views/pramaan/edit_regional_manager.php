...
<div class="content-body" style="overflow-x: hidden;"><!-- Basic form layout section start -->
	<div class=" breadcrumbs-top col-md-10 col-xs-12" style="margin-bottom: 10px;">
		<div class="breadcrumb-wrapper col-xs-12">
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><?php echo anchor('pramaan/regional_managers/','Regional Managers');?></li>
			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-header">
						<h4 class="card-title" id="bordered-layout-basic-form">Edit Regional Manager Info</h4>
								...
								<div class="form-body">
									...
									<div class="form-group row">
										...
										<div class="col-md-9" id="region_name">
											<?php echo form_dropdown('region_id[]',$region_options,'','id="region_id" class="form-control select2" placeholder="Select Region" multiple');?>
	...
	unhighlight: function(element) 
	{
	 ...
	 submitHandler: function (form) 
	 {
	 	var form="#regional_manager_form";
	      $.ajax({
	         type: "POST",
	         url: base_url+"pramaan/save_regional_manager",
	         ...
	         //alert(data.msg_info);
				 ...
				 if (data.status == true)
				 {
					 swal({
						 ...
						 function (confirmed) {
							 window.location.href = base_url+'pramaan/regional_managers/'+"<?php echo $parent_id;?>";
						 });
