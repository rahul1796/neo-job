	...
	<div class=" breadcrumbs-top col-md-10 col-xs-12" style="margin-bottom: 10px;">
		<div class="breadcrumb-wrapper col-xs-12">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active">Edit Sourcing Heads</li>
			</ol>
		</div>
	</div>
							...
							<form class="form form-horizontal form-bordered" id="sourcing_head_form" method="post">
								<div class="form-body">
									<div class="form-group row">
										...
										<div class="col-md-9">
											<input type="text" class="form-control" name="pname" id="pname" value="<?php echo $sourcing_head_info[0]['name'];?>">
									...
									<div class="form-group row">
										...
										<div class="col-md-9">
											<input type="text" class="form-control" name="email" id="email" maxlength="<?= EMAIL_MAX?> " value="<?php echo $sourcing_head_info[0]['email'];?>">
											<span class="error_label"></span>
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-md-9">
											<input type="text" class="form-control" name="phone" id="phone" maxlength="<?= PHONE_MAX?>" value="<?php echo $sourcing_head_info[0]['phone'];?>">
											<span class="error_label"></span>
										</div>
									</div>
...
$(document).ready(function()
{
	...
	unhighlight: function(element) 
	{
	 ...
	 submitHandler: function (form) 
	 {
	      $.ajax({
	         type: "POST",
	         url: base_url+"pramaan/edit_sourcing_head_update",
