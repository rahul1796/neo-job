...
<div class="content-body" style="overflow-x: hidden;"><!-- Basic form layout section start -->
	<div class=" breadcrumbs-top col-md-10 col-xs-12" style="margin-bottom: 10px;">
		<div class="breadcrumb-wrapper col-xs-12">
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><?php echo anchor("pramaan/bd_executives","BD Executive");?></li>
				<li class="breadcrumb-item active">Edit BD Executive</li>
			</ol>
		</div>
	</div>
			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-header">
						<h4 class="card-title" id="bordered-layout-basic-form">BD Executive Info</h4>
							...
							<form class="form form-horizontal form-bordered" id="sourcing_head_form" method="post">
								<div class="form-body">
									<div class="form-group row">
										...
										<input type="hidden" id="executive_id" name="executive_id" value="<?= $executive_id;?>"/>
										<input type="hidden" id="executive_id" name="id" value="<?= $executive_id;?>"/>

										<label for="pname" class="col-sm-3 label-control">Name<span class='validmark'>*</span></label>
										<div class="col-sm-9">
											<input type="text" class="form-control" name="pname" id="pname" value="<?php echo $executive_name;?>">
									...
									<div class="form-group row">
										...
										<div class="col-sm-9">
											<input type="text" class="form-control" name="phone" id="phone" maxlength="<?= PHONE_MAX?>" value="<?php echo $executive_phone;?>">
											<span class="error_label"></span>
										</div>
									</div>
									<div class="form-group row">
										...
										<div class="col-sm-9">
											<input type="text" class="form-control" name="email" id="email" maxlength="<?= EMAIL_MAX?> " value="<?php echo $executive_email;?>">
											<span class="error_label"></span>
										</div>
									</div>
...
$(document).ready(function()
{
	...
	unhighlight: function(element) 
	{
	 ...
	 submitHandler: function (form) 
	 {
	      $.ajax({
	         type: "POST",
	         url: base_url+"pramaan/edit_bd_executive_update",
