...
<?php
 	$employers_options=array('' => '-Select Employer-');
    foreach ($employer_list as $row)
    {
        $employers_options[$row['user_id']]=$row['employer_name'];
    }
?>
<div class="inner">
<h4>Add <?=$title ?></h4>
...
<hr/>
	...
	<div class="row form-box">
		   	<div class="col-sm-6 col-md-6">
                ...
                <!--<div class="form-group">
                    <label for="employer_id" class="col-sm-4 control-label">Assign Employers<span class='validmark'>*</span></label>
                    <div class="col-sm-8">
                    <?php //echo form_dropdown('employer_id',$employers_options,'','id="employer_id" class="form-control"');?>
                       <span class="error_label"></span>
                    </div>
                </div> -->
...
$(document).ready(function()
{
	...
	unhighlight: function(element) 
	{
	 ...
	 submitHandler: function (form) 
	 {
	      $.ajax({
	         type: "POST",
	         url: base_url+"pramaan/save_rs_executive",
