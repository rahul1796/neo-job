...
<strong>
  <ul class="breadcrumb">
    <li>
      <?php echo anchor("pramaan/dashboard","Dashboard");
        /*$action_flag=(empty($associates['id']))?"Add":"Edit";*/
         $action_flag=null;
       ?>   
    </li>
    <li class="active">
      <?= $action_flag;?> Employers <i class="fa fa-list"></i>
    </li>
  </ul>
</strong>
<hr/>
  <div class="row" style="margin-bottom: 5px;">
   ...
   <table id="table" class="table table-striped table-responsive" cellspacing="0" style="width:100%">
    <thead>
        <tr>
            <th>SlNo.</th>
            <th style="width:15%!important" nowrap>Employer Name </th>
            <th>Total Jobs </th>
            <th>Applied</th>
            <th>Screened</th>
            <th>Scheduled</th>
...
<div class="modal fade" id="modal_form_tracker" role="dialog">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="modal-body candidate_job_status" style="text-align: center;">
                -No records found-
            </div>
