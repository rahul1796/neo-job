 ...
 * @desc  recruitment support - Executive List
 * @date  Nov_2016
*/
select.input-sm 
{
...
<div class="content-body" style="overflow-x: hidden !important;">
    <?php
    if (intval($user_group_id) == 24 || intval($user_group_id) == 17)
        echo '<a class="btn btn-success btn-min-width mr-1 mb-1" href="' . base_url("pramaan/addedit_rs_executive") . '"><i class="icon-android-add"></i> Add RS Executives</a>';
    ?>
    ...
    <div class=" breadcrumbs-top col-md-9 col-xs-12">
        <div class="breadcrumb-wrapper col-xs-12">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Placement Executives
                </li>
            </ol>
        </div>
    </div>
            ...
            <div class="col-xs-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Available Placement Support Executives </h4>
                    ...
                    <div class="card-body collapse in">
                        <div class="card-block card-dashboard">
                            ...
                            <table id="tblRsExecutive" class="table table-striped table-bordered" style="width:100% !important;">
                                <thead>
                                <tr>
                                    <th>SNo.</th>
...
$(document).ready(function() {
    table = $('#tblRsExecutive').DataTable({
        //"stateSave": true,
        "serverSide": true,
        "paging": true,
        "scrollX": true,
        ...
        "ajax": {
            "url": base_url + "pramaan/rs_executive_list/",
            "type": "POST",
            error: function()
            {
                $("#tblRsExecutive tbody").empty().append('<tr><td style="text-align: center;" colspan="9">No data found</td></tr>');
            }
        },
        "columnDefs":
            [
    ...
    if (intval($user_group_id) == 17 || intval($user_group_id) == 24 ) {
...
function EditRSExecutiveDetails(RsExecutiveId)
{
    if (RsExecutiveId) {
        document.location.href = base_url + 'pramaan/addedit_rs_executive/' + RsExecutiveId;
    }
}
    ...
    swal(
        ...
        function(isConfirm) {
            if (isConfirm) {
                $.ajax({
                    type: "POST",
                    url: base_url + "pramaan/change_rs_executive_active_status",
                    data: {
                        'id': id,
