...
?>
<div class="inner">
<h4>Recruitment Support Managers </h4>
<small>
  <ul class="breadcrumb">
    ...
    ?>
    <li class="active">Placement Support Managers  </li>
  </ul>
</small>
<hr/>
  <div class="row" style="margin-bottom: 5px;">
    <div class="col-sm-3 col-md-3">
        <a class="btn btn-success btn-sm" href="<?php echo base_url("pramaan/add_rs_manager/$parent_id")?>"><i class="glyphicon glyphicon-plus"></i> Add Recruitment Support Manager</a>
    </div>
   ...
   <table id="table" class="table table-striped table-responsive" cellspacing="0" style="width:100%">
    <thead>
        <tr>
            <th>SlNo.</th>
            <th style="width:15%!important" nowrap>Placement Manager Name </th>
            <th>Email </th>
            <th>Phone </th>
            <th>Total <br>Placement Coordinators</th>
            <th>Action</th>
        </tr>
    </thead>
    <tbody>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
       ...
       // "order": [], //Initial no order.
        ...
        "ajax": {
            "url": base_url+"pramaan/rs_admins_list/"+"<?php echo $parent_id;?>",
            "type": "POST",
            error: function() 
...
{
    var url;
    url = base_url+"pramaan/save_rs_user";
...
function sub_admin_desk(rs_manager_id)
{
  if(rs_manager_id)
    {
        var url=(base_url+'pramaan/rs_coordinators/'+rs_manager_id);
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title">Recruitment Support Manager Form</h3>
            </div>
                ...
                <form action="#" id="form_sourcing_admin" class="form-horizontal">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            <label class="control-label col-md-3">Recruitment Manager Name<span class='validmark'>*</span></label>
                            <div class="col-md-9">
