...
<small>
  <ul class="breadcrumb" style="padding:0px; ">
    ...
    ?>
    <li class="active"> Sourcing Managers </li>
  </ul>
</small>
<hr/>
  <div class="row" style="margin-bottom: 5px;">
    <div class="col-sm-3 col-md-3">
        <a class="btn btn-success btn-sm" href="<?php echo base_url("pramaan/add_sourcing_manager/$parent_id")?>"><i class="glyphicon glyphicon-plus"></i> Add Sourcing Manager</a>
    </div>
   ...
   <table id="table" class="table table-striped table-responsive" cellspacing="0" style="width:100%">
    <thead>
        <tr>
            <th>SlNo.</th>
            <th style="width:15%!important" nowrap>Sourcing Manager Name </th>
            <th>Email </th>
            <th>Phone </th>
            <th>Assigned States </th>
            <th>Total Coordinator</th>
            <th>Action</th>
        </tr>
    </thead>
    <tbody>
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title">Sourcing Co-ordinator Details</h3>
            </div>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
       ...
       // "order": [], //Initial no order.
        ...
        "ajax": {
            "url": base_url+"pramaan/sourcing_managers_list/"+"<?php echo $parent_id;?>",
            "type": "POST",
            error: function()
            {  // error handling
...
function edit_user_admin(sourcing_manager_id)
{
    save_method = 'update';
    ...
    $.ajax({
        url : base_url+"pramaan/user_admin_by_id/" + sourcing_manager_id,
        type: "GET",
        dataType: "JSON",
...
function sub_admin_desk(sourcing_manager_id)
{
  if(sourcing_manager_id)
    {
        var url=(base_url+'pramaan/sourcing_coordinators/'+sourcing_manager_id);
