...
<script>
    ...
    table = $("#tblMain").DataTable({
        ...
        "ajax": {
            "url": base_url+"employer/get_customerwise_joined_candidate_data/"+ varCustomerId ,
            "type": "POST",
            error: function()
            {
...
//        }
        ...
        $.ajax({
            url: base_url + "employer/update_customer_joining_status",
            type: "POST",
