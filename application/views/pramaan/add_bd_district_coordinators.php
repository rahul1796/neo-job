...
<div class="content-body" style="overflow-x: hidden;"><!-- Basic form layout section start -->
	<div class=" breadcrumbs-top col-md-10 col-xs-12" style="margin-bottom: 10px;">
		<div class="breadcrumb-wrapper col-xs-12">
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><?php echo anchor("pramaan/bd_coordinators","District Coordinators");?></li>
...
$(document).ready(function()
{
	...
	$("#sourcing_head_form").validate({
	 ...
	 submitHandler: function (form) 
	 {
	      $.ajax({
	         type: "POST",
	         url: base_url+"pramaan/save_bd_district_coordinators",
	         ...
	         success: function (data) 
	         {
				...
				if (data.status == true) 
				{
					swal({
                        ...
                        function (confirmed) {
                            window.location.href = base_url+'pramaan/bd_coordinators';
                        });
