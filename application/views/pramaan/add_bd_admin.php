...
<div class="content-body" style="overflow-x: hidden;"><!-- Basic form layout section start -->
	<div class=" breadcrumbs-top col-md-10 col-xs-12" style="margin-bottom: 10px;">
		<div class="breadcrumb-wrapper col-xs-12">
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><?php echo anchor("pramaan/bd_admins_all","BD Admin");?></li>
				<li class="breadcrumb-item active">Add Recruitment Admin</li>
			</ol>
		</div>
	</div>
	<?php

	$bd_head_options=array('' => '-Select Recruitment Head-');
	foreach ($bd_head_list as $row)
	{
		$bd_head_options[$row['user_id']]=$row['name'];
							...
							<form class="form form-horizontal form-bordered" id="sourcing_admin_form" method="post">
								<div class="form-body">
									<div class="form-group row">
										...
										<!--    <input type="hidden" id="sourcing_admin_id" name="id" value="0"/>
                                          --> <!--  -->
										<label for="pname" class="col-sm-3 label-control">Name<span class='validmark'>*</span></label>
										<div class="col-sm-9">
											<input type="text" class="form-control" name="pname" id="pname" placeholder="Enter BD Admin Name">
									...
									<div class="form-group row">
										...
										<div class="col-sm-9">
											<input type="text" class="form-control" name="phone" id="phone" maxlength="<?= PHONE_MAX?>" placeholder="Enter BD Admin Phone">
											<span class="error_label"></span>
										</div>
									</div>
									<div class="form-group row">
										...
										<div class="col-sm-9">
											<input type="text" class="form-control" name="email" id="email" maxlength="<?= EMAIL_MAX?>" placeholder="Enter BD Admin Email">
											<span class="error_label"></span>
										</div>
									</div>
									<div class="form-group row">
										<label for="bd_head" class="col-sm-3 label-control">BD head<span class="validmark">*</span></label>
										<div class="col-sm-9">
											<?php echo form_dropdown('bd_head',$bd_head_options,'','id="bd_head" class="form-control" ');?>
											<span class="error_label"></span>
										</div>
									</div>
									<div class="form-group row">
										...
										<div class="col-sm-9">
											<input type="password" class="form-control" name="password" id="mainpassword" maxlength="<?= PASSWORD_MAX?>" placeholder="Enter Password">
											<span class="error_label"></span>
										</div>
									</div>
									<div class="form-group row">
	...
	unhighlight: function(element) 
	{
		...
		$(element).removeClass('error_label');
		 ...
		 submitHandler: function (form)
		 {
			 $.ajax({
				 type: "POST",
				 url: base_url+"pramaan/save_bd_admin",
				 ...
				 success: function (data)
				 {
					 ...
					 if (data.status == true)
					 {
						 ...
						 swal({
							 ...
							 function (confirmed) {
								 window.location.href = base_url + "pramaan/bd_admins_all/";
							 });
						 //window.location.href = base_url+'pramaan/bd_admins_all/';
					 }
					 else
