...
<style type="text/css">
	 ...
	 * @desc  	Add / Edit language version questions
	 * @date  	March 2017
	*/
	select.input-sm
	{
	...
	<div class=" breadcrumbs-top col-md-10 col-xs-12" style="margin-bottom: 10px;">
		<div class="breadcrumb-wrapper col-xs-12">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active">Add / Edit Question Language Version</li>
							...
							<form class="form form-horizontal form-bordered" id="frmEntry" method="post" enctype="multipart/form-data">
								...
								<div class="form-body" style="margin-top: -25px;">
									<div id="divQuestionPaperTitle"  class="form-group row">
										...
										<div class="col-sm-9">
											<input type="text" class="form-control" id="txtQuestionPaperTitle" name="txtQuestionPaperTitle" value="<?= isset($ResponseData[0]['question_paper_title']) ? $ResponseData[0]['question_paper_title'] : "" ?>" onkeydown="return false;" disabled="disabled"/>
										</div>
									</div>
...
<script type="text/javascript">
	var langArray = [ 'gu', 'hi', 'kn', 'ml', 'ta', 'te', 'bn', 'mr' ];
	...
	function listLanguage_OnChange()
	{
		...
		if (varSelectedIndex > 0)
		{
			...
			$.ajax({
				url: base_url + "content/get_question_detail_for_language/<?= $QuestionId ?>/" + varSelectedValue,
				type: "POST",
				data: {},
				dataType:'json',
...
$(document).ready(function()
{
	$("#frmEntry").on('submit',(function(e)
	{
		...
		if (varSelectedIndex > 0)
		{
			...
			$.ajax({
				url: base_url + "content/save_question_language_version_data",
				type: "POST",
				data: {
				...
				success: function (result)
				{
					...
					if (varLangQuestionId > 0)
					{
						swal({
								title: "",
								text: language_name + " Version for this question has been saved successfully!",
