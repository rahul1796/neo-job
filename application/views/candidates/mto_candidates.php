<div class="content-body" style="padding: 30px;margin-top: -15px;">
  ...
  <div class=" breadcrumbs-top col-md-9 col-xs-12" style="margin-left: -25px;">
    <div class="breadcrumb-wrapper col-xs-12">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">MTO Candidates
        </li>
      </ol>
    </div>
  </div>
  ...
  <div class="row">
    <div class="col-md-12">
      <form class="" action="<?php echo base_url('CandidatesController/mtocandidates/'.$job_id);?>" method="GET">
                ...
                <div class="row">
                  ...
                  <?php else: ?>
                    <div class="col-md-12 card-block" style="text-align:center;">
                      <h5 class="text-center">No MTO Candidates Found</h5>
                    </div>
                  <?php endif;?>
                  <div class="col-md-12">
