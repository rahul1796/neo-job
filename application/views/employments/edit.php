    ...
    <div class=" breadcrumbs-top col-md-10 col-xs-12" style="margin-bottom: 10px;margin-left: -25px;">
        <div class="breadcrumb-wrapper col-xs-12">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Edit Employment</li>
            </ol>
        </div>
    </div>
</div>
...
<form action="<?php echo base_url('/employmentscontroller/update/').$data['fields']['candidate_id'].'/'.$id;?>" enctype="multipart/form-data" method="POST">
