...
$options_employers = array(''=>'');
   foreach ($employers_list as $row) {
   	 
      $options_employers[$row['user_id']]=$row['name'];

   }

$options_jobroles=array(''=>'');
							...
							<form class="form form-horizontal form-bordered" id="post_job_form" method="post">
								<div class="form-body">
									...
									<div class="form-group row">
										...
										<div class="col-sm-9">
											<?php echo form_dropdown('employer_id',$options_employers, $job_data['employer_id'], 'class="form-control" data-placeholder="Select Employer" id="employer_id"');?>
									...
									<div class="form-group row">
										...
										<div class="col-sm-9">
											<?php echo form_dropdown('job_role',$options_jobroles, $job_data['qualification_pack_id'], 'class="form-control" data-placeholder="Select Job Role" id="job_role"');?>
											<span class="error_label"></span>
										</div>
									</div>
									<div class="form-group row">
										...
										<div class="col-sm-9">
											<?php echo form_dropdown('department_id',$options_departments, $job_data['department_id'], 'class="form-control" id="department_id"');?>
											<span class="error_label"></span>
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-9">
											<?php echo form_dropdown('job_category_id',$options_category, $job_data['job_category_id'], 'class="form-control" id="category"');?>
											<span class="error_label"></span>
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-9">
											...
											<div class="field_wrapper">
												<div class="input-group">
													<input class="form-control" name="questions[]" type="text" placeholder="Type a Question 1" value="<?php echo $job_data['question_one']?>" />
													<span class="input-group-btn"><button class="btn add-button" type="button">+</button></span>
												</div>
												<?php if($job_data['question_two']!='')
														{ ?>
															<div class='input-group'>
															<input class='form-control' name='questions[]' type='text' placeholder='Type a Question 2' value="<?php echo $job_data['question_two']?>" />
															<span class='input-group-btn'><button class='btn remove_button' type='button'>-</button></span>
															</div>
												<?php	} ?>

								     			<?php if($job_data['question_three']!='')
														{ ?>
															<div class='input-group'>
															<input class='form-control' name='questions[]' type='text' placeholder='Type a Question 3' value="<?php echo $job_data['question_three']?>" />
															<span class='input-group-btn'><button class='btn remove_button' type='button'>-</button></span>
															</div>
												<?php	} ?>
											</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-9">
											<textarea class="form-control" rows="2" id="job_desc" name="job_desc" placeholder="Job description" maxlength="500" ><?php echo $job_data['job_desc'];?></textarea>
											<span class="error_label"></span>
										</div>
									</div>
									<div class="form-group row">
										...
										<div class="col-sm-9">
											<textarea class="form-control" rows="2" id="job_address" name="job_address" placeholder="Address" ><?php echo $job_data['job_address'];?></textarea>
											<span class="error_label"></span>
										</div>
									</div>
								</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-9">
											<?php echo form_dropdown('min_qualification',$options_qualification,$job_data['min_qualification_id'], 'class="form-control" id="min_qualification"');?>
											<span class="error_label"></span>
										</div>
									</div>
									<div class="form-group row">
										...
										<div class="col-sm-9">
											<div class="row">
												<div class="col-sm-6">
													<input type="text" class="form-control" name="min_experience" id="min_experience" maxlength="10" placeholder="Min. Experience" value="<?php echo $job_data['min_experience']?>" required />
												</div>
												<div class="col-sm-6">
													<input type="text" class="form-control" name="max_experience" id="max_experience" maxlength="10" placeholder="Max. Experience" value="<?php echo $job_data['max_experience']?>" required/>
												</div>
											</div>
											<span class="error_label"></span>
									...
									<div class="form-group row">
										...
										<div class="col-sm-9">
											<div class="row">
												<div class="col-sm-6">
													<input type="number" class="form-control" name="min_age" id="min_age" maxlength="10" placeholder="Min. Age" value="<?php echo $job_data['min_age']?>" required/>
												</div>

												<div class="col-sm-6">
													<input type="number" class="form-control" name="max_age" id="max_age" maxlength="10" placeholder="Max. Age" value="<?php echo $job_data['max_age']?>" required/>
												</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-9">
											<div class='input-group date' id='last_date_apply'>
												<input type="text" class="form-control" name="last_date_apply" placeholder="DD/MM/YYYY" value="<?php echo date('d-M-Y',strtotime($job_data['last_date_apply']))?>"/>
											</div>
											<span class="error_label"></span>
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-9">
											<input type="text" class="form-control" name="contact_name" id="contact_name" maxlength="50" placeholder="Contact Person Name" value="<?php echo $job_data['contact_name']?>" />
											<span class="error_label"></span>
										</div>
									</div>
									<div class="form-group row">
										...
										<div class="col-sm-9">
											<input type="text" class="form-control" name="email" id="email" maxlength="<?= EMAIL_MAX?>"  placeholder="Email" value="<?php echo $job_data['contact_email']?>"/>
											<span class="error_label"></span>
										</div>
									</div>
									<div class="form-group row">
										...
										<div class="col-sm-9">
											<input type="text" class="form-control" name="phone" id="phone" maxlength="<?= PHONE_MAX?>" placeholder="Phone" value="<?php echo $job_data['contact_phone']?>"/>
											<span class="error_label"></span>
										</div>
									</div>
					...
					<?php //echo form_dropdown('rec_sup_exec_id',$options_rec_sup_exec, '', 'class="form-control" id="rec_sup_exec_id"');?>
				  	<span class="error_label"></span>
								...
								<div class="form-group row">
									...
									<div class="col-sm-9">
										<?php echo form_dropdown('listing_id',$options_listings, $job_data['listing_id'], 'class="form-control" id="listing_id"');?>
										<span class="error_label"></span>
									</div>
								</div>
								...
								<div class="form-group row" id="multilocation">
									...
									<div class="col-md-9">
										<div class="field_wrapper1">
											...
											<?php
											if(count($job_detail)>=1)
											{
													$x1=1;
													foreach ($job_detail as $drow) 
													{
													?>
														...
														<div class="row">
															...
															<div class="col-md-3">
																<div class="form-group row" style="border-bottom: none;">
																	...
																	<?php echo form_dropdown('location[]',$options_districts, $drow['location_id'], 'class="form-control location" required');?>
																	<span class="error_label"></span>
																</div>
															</div>
															...
															<div class="col-md-3">
																<div class="form-group row">
																	<input type="number" class="form-control" name="no_of_openings[]" placeholder="No of openings" value="<?php echo $drow['no_of_openings']?>" required/>
																	<span class="error_label"></span>
																</div>
															</div>
															<div class="col-md-5">
																<div class="row">
																	<div class="col-md-6">
																		<div class="form-group row">
																			<input type="text" class="form-control min_salary" name="min_salary[]" maxlength="10" placeholder="Min. Salary" value="<?php echo $drow['min_salary']?>" required/>
																			<span class="error_label"></span>
																		</div>
																	</div>
																	<div class="col-md-6">
																		...
																		<div class="form-group row">
																			<input type="text" class="form-control max_salary" name="max_salary[]" maxlength="10" placeholder="Max. Salary" value="<?php echo $drow['max_salary']?>" required "/>
																			<span class="error_label"></span>
																		</div>
																	</div>
																</div>
											...
											?>
												<div class="input-group add_location" style="padding-bottom:10px!important;">
													<div class="row">
														...
														<div class="col-md-3">
															<div class="form-group row">
																<input type="number" class="form-control" name="no_of_openings[]" placeholder="No of openings" required/>
																<span class="error_label"></span>
															</div>
														</div>
														<div class="col-md-5">
									...
									<div class="form-actions" style=" float: right; margin-top: 10px;">
										...
										<button type="submit" class="btn btn-primary" name="submit" value="update"><i class="icon-check2"></i>Save Job</button>
									</div>
							</form>
...
//ends
    ...
    var question_two="<?php echo ($job_data['question_two']!='')?1:0;?>";
    var question_three="<?php echo ($job_data['question_three']!='')?1:0;?>";
    ...
    { //Once add button is clicked
		...
		fieldSET += '<div class="col-md-3">\
					...
					<span class="input-group-btn"><button class="btn remove_div" type="button">-</button></span>\
					</div>';
