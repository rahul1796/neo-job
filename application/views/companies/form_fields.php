...
<div class="form-group row">
   ...
   <input type="text"  class="form-control" id="company_name" placeholder="Enter Company Name" name="company_name" value="<?php echo $fields['company_name'] ?? ''; ?>">
...
<div class="form-group row">
  <div class="col-md-12">
    ...
    <textarea name="company_description" rows="8" class="form-control"><?php echo $fields['company_description'] ?? ''; ?></textarea>
